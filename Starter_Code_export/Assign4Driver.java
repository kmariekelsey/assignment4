...
public class Assign4Driver
{
	...
	/**
	 * Print word ladder with delimiting symbol as asterisks. Each
	 * word gets its own line.
	 * 
	 * @param result: Array word ladder to print
	 */
	private static void printWordLadder(List<String> result) {
